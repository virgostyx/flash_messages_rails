...
Gem::Specification.new do |spec|
  spec.name        = "flash_messages_rails"
  spec.version     = FlashMessages::VERSION
  spec.authors     = ["Virgo STYX"]
  spec.email       = ["virgostyx@gmail.com"]
  spec.homepage    = "https://github.com/virgostyx/flash_messages_rails"
  ...
  spec.metadata["changelog_uri"]   = "https://github.com/virgostyx/flash_messages_rails/blob/main/CHANGELOG.md"
